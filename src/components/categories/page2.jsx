...
import productImage6 from "../../assets/pic6.jpg";
import productImage7 from "../../assets/pic7.jpg";
import productImage8 from "../../assets/pic8.jpg";
import { motion } from "framer-motion";

export default function CategoryPage2() {
  ...
  const products = [
    ...
    {
      id: 6,
      name: "Luxury Teak Swing",
      description: "Premium finish swing with cushioned seat.",
      price: 18000,
      originalPrice: 21000,
      image: productImage6,
      category: "Wooden Swings",
    ...
    {
      id: 7,
      name: "Kids Single Seat Swing",
      description: "Fun and safe swing for children indoor and outdoor.",
      price: 4000,
      originalPrice: 5500,
      image: productImage7,
    ...
    {
      id: 8,
      name: "Portable Macrame Swing",
      description: "Foldable swing ideal for small balconies.",
      price: 6000,
      originalPrice: 8000,
      image: productImage8,
      category: "Macrame Swings",
  ...
  return (
    <div className="bg-amber-50 pt-20 min-h-screen px-4 py-8 md:px-8 lg:px-16">
      <div className="text-center mb-8">
        <h1 className="text-2xl pt-15 font-la-mango">Shop By Categories2</h1>
        <p className="text-sm text-gray-500 pt-3 pb-8">Home / Shop By Categories2</p>
      </div>
        ...
        {sortedProducts.map((product) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600 group-hover:text-gray-300 mt-1 line-clamp-2">
                {product.description}
              </p>
      ...
      <div className="text-center mt-10 flex justify-center gap-4">
        {location.pathname === "/categories/page2" && (
          <>
            <Link
              to="/categories"
